...
function exampleClear(){
    ...
    courses.clear();
    console.log(`After clear, the course map size is ${courses.size}`);
} // end function
...
function exampleDelete(){
    console.log(`The days of the wekk are ${getDays().size} in total`);
    let days = getDays();
...
function exampleGetHas(){
     ...
     console.log(`Course 1 ${course1}. Course 2 is ${course2}`);
