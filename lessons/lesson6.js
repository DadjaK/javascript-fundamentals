...
function exampleAddSubstract(num1, num2){
    const add = num1 + num2;
    const sub = num2 -num1;
...
exampleAddSubstract(7, 12);
;
exampleMultiplyDivide(4, 14);

/* Modulus */
/* Displays the remainder of a division problem */
function exmapleModulus(){
    const answer1 = 10 % 4;
    const answer2 = 12 % 3;
...
function exampleExponent(value){
...
function substractAssign(){
    let numSub1 = 20;
    let numSub2 = 8;
    numSub1 -=numSub2;
    console.log(`Substraction Assignment Operator ${numSub1}`);
} // end function
...
function divideAssign(num7, num8){
    num7 /= num8
    console.log(`Divide Assignment Operatot ${num7}`);
} // end function
...
function modulusAssign(num9){
    num9 %= 34
    console.log(`Modulus Assignment Operatot ${num9}`);
} // end function
...
function logicalExample(num10, num11){
    ...
    console.log(`Able = ${able} Beta = ${beta} Charlie = ${charlie}`);
...
function incrementExample() {
    let delta = 10;
    const sum = delta++;
    console.log(`Increment Post - delta ${delta}, sum ${sum}`);
    let echo = 5;
    const sum2 = ++echo;
