...
/* Using the built-in fuction timeOut */
const note = function(){
    console.log('This note wil show in 3 seconds');
};
...
setTimeout(function(){
    console.log('Anomymous Function shows in 4 seconds');
}, 4000);
...
function score(grade){
    switch(grade){
        ...
        case 'C':
            ...
            break;
        case 'D':
            console.log(`You got a ${grade}, let's do better`);
            break;
        default:
...
in a cleaner stylr that doesn't need the promise chains. */
